...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  public static String createScaledVersion(String picture, double wFactor, double hFactor){
		String smallVersion = "small";
		String firstLetter = Character.toString(picture.charAt(0));
		firstLetter.toUpperCase();
		
		smallVersion += firstLetter;
		smallVersion += picture.substring(1,picture.length());
		
		Picture p = new Picture(picture);
		Picture smallP = p.scale(wFactor,hFactor);
		smallP.write(smallVersion); 
		return smallVersion;
	}
  /**
  ...
  public static void main( String args[])
  {
	...
	//increase w and h of elephant.jpg by 2
	String koalaV2 = createScaledVersion("elephant.jpg", 2, 2);
	
	Picture pix2 = new Picture(koalaV2);
	pix2.explore();
  }
